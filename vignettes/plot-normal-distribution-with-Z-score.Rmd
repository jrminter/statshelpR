...
This example is adapted from a YouTube video by  
[OpenIntro](https://www.youtube.com/watch?v=S_p5D-YXLS4)
and plotting help from
[dkmathstats.com](http://dkmathstats.com/plotting-normal-distributions-in-r-using-ggplot2/).
...
zPlt <- ggplot(xvalues, aes(x = xvalues)) +
		...
		scale_x_continuous(breaks = seq(from = -zLim, to = zLim, by = 1),
						   limits = c(-zLim, zLim)) +
		xlab("Z") +
		ylab("density")
print(zPlt)
